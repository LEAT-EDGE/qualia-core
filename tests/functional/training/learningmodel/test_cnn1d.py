...
class TestModelsCNN1D(TestCase):
    ...
    def test_cnn_1d_pytorch(self):
        ...
        # prepool
        self.assertIsInstance(trainresult.model.layers.prepool, AvgPool1d)
        self.assertEqual(tuple(trainresult.model.layers.prepool.kernel_size), (2,))
        self.assertEqual(tuple(trainresult.model.layers.prepool.stride), (2,))

        # 1st conv block
        self.assertIsInstance(trainresult.model.layers.conv1, Conv1d)
        self.assertEqual(tuple(trainresult.model.layers.conv1.weight.shape), (4, 1, 5)) # 4*1*5 = 20
        self.assertIsNone(trainresult.model.layers.conv1.bias) # 4
        self.assertIsInstance(trainresult.model.layers.bn1, BatchNorm1d)
        ...
        self.assertIsInstance(trainresult.model.layers.maxpool1, MaxPool1d)
        ...
        # 2nd conv block
        self.assertIsInstance(trainresult.model.layers.conv2, Conv1d)
        self.assertEqual(tuple(trainresult.model.layers.conv2.weight.shape), (6, 4, 3)) # 6*4*3 = 72
        self.assertIsNone(trainresult.model.layers.conv2.bias) # 6
        self.assertIsInstance(trainresult.model.layers.bn2, BatchNorm1d)
        ...
        self.assertIsInstance(trainresult.model.layers.maxpool2, MaxPool1d)
        ...
        self.assertEqual(trainresult.model.layers.fc1.weight.shape, (10, 12)) # 120
